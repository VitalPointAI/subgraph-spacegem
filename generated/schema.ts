...
export class NftMint extends Entity {
  constructor(id: string) {
    ...
    this.set("token_ids", Value.fromStringArray(new Array(0)));
  }
  ...
  get token_ids(): Array<string> {
    let value = this.get("token_ids");
    return value!.toStringArray();
  }

  set token_ids(value: Array<string>) {
    this.set("token_ids", Value.fromStringArray(value));
  }
}
